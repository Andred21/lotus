    ...
    <AppCard>
      ...
      >
        <AppColumn
          ...
          style={LARGURA_CARGA_RELATOR.name}
          sortable
        ...
        <AppColumn
          ...
          style={LARGURA_CARGA_RELATOR.current}
          sortable
        ...
        <AppColumn
          ...
          style={LARGURA_CARGA_RELATOR.upcoming}
          sortable
        ...
        <AppColumn
          ...
          style={LARGURA_CARGA_RELATOR.expired}
          sortable
        ...
        <AppColumn
          ...
          style={LARGURA_CARGA_RELATOR.expiring}
          sortable
