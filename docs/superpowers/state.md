...
|---|---|---|---|---|---|
| `lane-a` | **29** `backend-config-e-conteudo-de-documento` (`P-79`, `P-75`, `P-59`) | Backend | main tree (gate P-03) | — (abre no `/executar-bloco`); a anterior, `chore/harness-hooks-de-guarda`, **mesclou** na PR #106 (`38e08a08`) | `planning` |
