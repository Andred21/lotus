...
updated_at: 2026-08-19T19:10:00-03:00
---
...
## Penúltimo item fechado — 2026-08-18 (`arquivados-e-restauracao`, Próximos blocos item 1)
...
como **D-34** no `backlog.md`, com gatilho no primeiro deploy. Casar por `deleted_at` é o que a spec
...
**Fica registrada a D-34** no `backlog.md`: `archived_with_parent` nasceu sem backfill e não há como
