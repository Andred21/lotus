...
- **A numeração não se renumera quando um item fecha.** O `1` saiu em 2026-08-22, o `14` no mesmo
  dia e o `3` em 2026-08-23; a fila começa no `2` e salta o `3` de propósito: o número é identidade
  estável, citada pelas fichas de `pendencias/` e pelos próprios blocos. Renumerar quebraria as
  citações e pareceria promoção.
