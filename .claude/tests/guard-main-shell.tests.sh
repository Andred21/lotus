...
# --- fix final de review: os escapes do fix 1 e do fix 2 fim a fim, pelo
...
for _escape in 'git push --forc\e origin main' \
               ...
               'git worktree remov\e ../outra' \
               'sort -o backend/Evil.php /etc/hostname'; do
